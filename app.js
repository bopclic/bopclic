...
// Wrap every letter in a span
var textWrapped = document.querySelector('.ml10 .letters');
textWrapped.innerHTML = textWrapped.textContent.replace(/\S/g, "<span class='letter'>$&</span>");
...
// Wrap every letter in a span
var textWrap = document.querySelector('.ml2');
